...
const app = {
  initPages: function(){
    ...
    let pageMacthingHash = thisApp.pages[0].id;
    for(let page of thisApp.pages){
      if(page.id == idFromHash){
        pageMacthingHash = page.id;
        break;
      }
    }

    thisApp.activatePage(pageMacthingHash);
  ...
  activatePage: function(pageId){
    ...
    /* add class "active" to matching links, remove from non-matching pages */
    for(let link of thisApp.navLinks){
