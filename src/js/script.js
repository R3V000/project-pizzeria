...

{
  ...
  const select = {
    ...
    widgets: {
      amount: {
        input: 'input.amount',      //CHANGE CODE LATER BCS IT BUGS
  ...
  class Product {
    ...
    prepareCartProduct(){
      ...
      productSummary.price = thisProduct.priceFull;
      productSummary.params = thisProduct.prepareCartProductParams();

      
      ////console.log('productSummary: ',productSummary.id,productSummary.name,productSummary.amount,productSummary.priceSingle,productSummary.price);
      return productSummary;
    }

    prepareCartProductParams(){
      const thisProduct = this;
      //console.log('Inside prepareCartProductParams: ');
  ...
  class AmountWidget {
    ...
    setValue(value){
      ...
      /* TODO: Add validation for new value */
  ...
  class Cart {
    ...
    update(){
      ...
      console.log('total price',thisCart.totalPrice,'subtotal price',thisCart.subtotalPrice,'total number',thisCart.totalNumber);
  ...
  class CartProduct {
    ...
    initAmountWidget(){
      ...
      thisCartProduct.dom.amountWidget.addEventListener('updated', function(){
        ...
        thisCartProduct.price = thisCartProduct.amountWidget.value * thisCartProduct.singlePrice;
